...
const Register = () => {
  ...
  return (
    ...
    >
      ...
      {/* Register Card */}
      <div className="relative z-10 bg-white/80 backdrop-blur-md shadow-2xl rounded-3xl p-10 w-[32rem] border border-purple-100 flex flex-col justify-center mt-20 mb-23">
